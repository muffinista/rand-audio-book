...
# docker build -t rand-audio -f Dockerfile . && docker run --rm -it -v
# "$PWD":/usr/src/app -v "$PWD/../rand-audio-samples":/usr/src/app/samples
# rand-audio ./sample-single-digits.py
